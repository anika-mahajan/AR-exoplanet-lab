...
public class GenerateStars : MonoBehaviour
{
    ...
    private void createStarObject(string starName, Vector3 position, float radius, float distance, float luminosity, string type) {
        ...
        if (s.transform.localPosition.y + 2.7432f > 2.8f) {
            ...
            s.transform.localPosition = new Vector3(s.transform.localPosition.x, UnityEngine.Random.Range(2.8f, 7f), s.transform.localPosition.z);
        }
